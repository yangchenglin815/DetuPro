...
typedef struct GlModel {
    ...
    GLfloat projectionMatrix[GL_MODEL_MATRIX_SIZE];
    GLfloat mvpMatrix[GL_MODEL_MATRIX_SIZE];
    GLfloat modelMatrix[GL_MODEL_MATRIX_SIZE];
	GLfloat leftmodelMatrix[GL_MODEL_MATRIX_SIZE];
	GLfloat rightmodelMatrix[GL_MODEL_MATRIX_SIZE];
    ...
    GLuint textureIds[GL_MODEL_MAX_TEXTURE_ID_SIZE]; //纹理ids
    int textureIdSize;
	GLuint weighttexID;
