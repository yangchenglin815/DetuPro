...
typedef struct RenderCompatibilityCallBack {
	void(*onUpdateTexImage)(void* opaque, int index, float outCoords[RC_TEXTURE_TRANSFORM_MATRIX_SIZE]);
} RenderCompatibilityCallBack;

typedef struct RenderCompatibilityRenderCallBack {
	void(*onRenderCompatibilityRendeAfter)(void* opaque);
} RenderCompatibilityRenderCallBack;
...
void renderCompatibility_setRenderCallBack(RenderCompatibility *renderCompatibility, void* opaque, RenderCompatibilityRenderCallBack* callBack);
