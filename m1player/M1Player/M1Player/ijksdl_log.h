...
#define VLOGV(...)  Log::Debug(__VA_ARGS__)
#define VLOGD(...)  Log::Debug(__VA_ARGS__)
#define VLOGI(...)  Log::Info(__VA_ARGS__)
#define VLOGW(...)  Log::Warn(__VA_ARGS__)
#define VLOGE(...)  Log::Error(__VA_ARGS__)

#define ALOGV(...)  Log::Debug(__VA_ARGS__)
#define ALOGD(...)  Log::Debug(__VA_ARGS__)
#define ALOGI(...)  Log::Info(__VA_ARGS__)
#define ALOGW(...)  Log::Warn(__VA_ARGS__)
#define ALOGE(...)  Log::Error(__VA_ARGS__)
#define LOG_ALWAYS_FATAL(...)   do { ALOGE(__VA_ARGS__); exit(1); } while (0)

#endif

#if !defined(_WIN32) && !defined(_WIN64)
#define IJK_LOG_TAG "m1_decoder"
