...
extern "C" {
	...
	static const char STANDARD_VERTEXT_SHADER[] = PANO_GLES_STRINGIZE(
		uniform mat4 u_MVPMatrix;
	attribute vec4 a_Position;
	attribute  vec2 a_TexCoordinate;
	varying vec2 v_TexCoordinate;
	...
	static const char STANDARD_FRAG_SHADER[] = PANO_GLES_STRINGIZE(
		uniform sampler2D u_Texture;
	varying vec2 v_TexCoordinate;
	void main()
	{
	...
	//SphereEye SHADER
	static const char SphereEye_VERTEXT_SHADER[] = PANO_GLES_STRINGIZE(
		uniform mat4 u_MVPMatrix;
	attribute vec4 a_Position;
	attribute vec2 a_TexCoordinate;
	varying vec2 v_TexCoordinate;
	...
	static const char SphereEye_FRAG_SHADER[] = PANO_GLES_STRINGIZE(
		uniform sampler2D u_Texture;
	varying vec2 v_TexCoordinate;
	varying float v_pos_y;
	uniform float ylimt;
	...
	//Sphere2Eye SHADER
	static const char Sphere2Eye_VERTEXT_SHADER[] = PANO_GLES_STRINGIZE(
		attribute vec4 a_Position;
	...
	static const char Sphere2Eye_FRAG_SHADER[] = PANO_GLES_STRINGIZE(
		varying  float v_pos_x;
	varying  float v_pos_y;
	varying  float v_pos_z;
	varying  vec2 v_TexCoordinateA;
	...
	static const char Sphere4Eye_VERTEXT_SHADER[] = PANO_GLES_STRINGIZE(
		uniform mat4 u_MVPMatrix;
	attribute vec4 a_Position;
	...
	attribute  vec2 a_weightCoordinate0;
	attribute  vec2 a_weightCoordinate1;
	attribute  vec2 a_weightCoordinate2;
	attribute  vec2 a_weightCoordinate3;
	...
	varying  vec2 v_weightCoordinate0;
	varying  vec2 v_weightCoordinate1;
	varying  vec2 v_weightCoordinate2;
	varying  vec2 v_weightCoordinate3;
	...
	void main() {
		...
		v_weightCoordinate0 = a_weightCoordinate0;
		v_weightCoordinate1 = a_weightCoordinate1;
		v_weightCoordinate2 = a_weightCoordinate2;
		v_weightCoordinate3 = a_weightCoordinate3;
	}
	);

	static const char Sphere4Eye_FRAG_SHADER[] = PANO_GLES_STRINGIZE(
	varying  vec2 v_TexCoordinate0;
	varying  vec2 v_TexCoordinate1;
	varying  vec2 v_TexCoordinate2;
	varying  vec2 v_TexCoordinate3;
	...
	void main() {
		...
		weightcol[0] = texture2D(weight_Texture, v_weightCoordinate0).r;
		weightcol[1] = texture2D(weight_Texture, v_weightCoordinate1).r;
		weightcol[2] = texture2D(weight_Texture, v_weightCoordinate2).r;
		weightcol[3] = texture2D(weight_Texture, v_weightCoordinate3).r;
		if (viewtype == 1){//全景模式
