unit RRU2881_DLL_Head;

interface

Const

    RRU2881_DLLName = 'RRU2881.dll'; 
...
type
    RTempRecord=Record
     ...
     Function OpenNetPort(Port : LongInt;
                    IPaddr:string;
                     var ComAdr : byte;
                     var frmcomportindex:longint): LongInt; stdcall;external RRU2881_DLLName ;
    Function CloseNetPort( frmComPortindex : longint ): LongInt; stdcall; external RRU2881_DLLName ;

      Function OpenUSBPort(var ComAdr : byte;
                     var frmcomportindex:longint): LongInt; stdcall;external RRU2881_DLLName ;
    Function CloseUSBPort( frmComPortindex : longint ): LongInt; stdcall; external RRU2881_DLLName ;

    Function OpenComPort(Port : LongInt;
                          var ComAdr : byte;
                          Baud:byte;
                          var frmcomportindex: longint): LongInt;
                          stdcall; external RRU2881_DLLName ;
...
//EPC  G2
     ...
     Function InventoryMix_G2(var ComAdr:Byte;
                          QValue,Session:Byte;
                          MaskMem:Byte;
                          MaskAdr:PChar;
                          MaskLen:Byte;
                          MaskData:PChar;
                          MaskFlag,ReadMem:Byte;
                          ReadAdr:PChar;
                          ReadLen:Byte;
                          Psd:PChar;
                          Target,InAnt,Scantime,FastFlag:Byte;
                          pEPCList:PChar;
                          var Ant:Byte;
                          var Totallen:LongInt;
                          var CardNum:LongInt;
...
//18000_6B
  ...
  Function InventoryBuffer_G2(var ComAdr:Byte;
    ...
    Function WriteRfPower(var ComAdr:Byte;
                        powerDbm:Byte;
                        frmComPortindex : longint ): LongInt;
                        stdcall;external RRU2881_DLLName ;

    Function ReadRfPower(var ComAdr:Byte;
                        var powerDbm:Byte;
                        frmComPortindex : longint ): LongInt;
                        stdcall;external RRU2881_DLLName ;

    Function RetryTimes(var ComAdr:Byte;
                        var Times:Byte;
                        frmComPortindex : longint ): LongInt;
                        stdcall;external RRU2881_DLLName ;

    Function SetDRM(var ComAdr:Byte;
                        DRM:Byte;
                        frmComPortindex : longint ): LongInt;
                        stdcall;external RRU2881_DLLName ;
    Function GetDRM(var ComAdr:Byte;
                        var DRM:Byte;
                        frmComPortindex : longint ): LongInt;
                        stdcall;external RRU2881_DLLName ;

    Function GetReaderTemperature(var ComAdr:Byte;
                        var PlusMinus,Temperature:Byte;
                        frmComPortindex : longint ): LongInt;
                        stdcall;external RRU2881_DLLName ;

    Function MeasureReturnLoss(var ComAdr:Byte;
                        TestFreq:PChar;
                        Ant:Byte;
                        var ReturnLoss:Byte;
                        frmComPortindex : longint ): LongInt;
